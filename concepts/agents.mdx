...
<Columns cols={2}>
  ...
  <Card title="Knowledge bases" icon="book-open" href="/concepts/knowledge-base">
  ...
  <Card title="Evaluation" icon="bar-chart" href="/concepts/evaluations">
    Optional automatic scoring of each call across accuracy and experience.
  </Card>
